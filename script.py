...
# print(r);
# print(r['cliente']['cnpjcpf']);
# print(r['exportador']['cnpjcpf']);
...
produtos = Select(nav.find_element(By.XPATH,'/html/body/form/div/center/table[1]/tbody/tr[6]/td[2]/select'))
produtos.select_by_value('17011100')
